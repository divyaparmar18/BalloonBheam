...
function preload() {
    bluecapImg = loadImage("blue1.png");
    yellowcapImg = loadImage("yello.png");
    redcapImg = loadImage("red1.png");
    balloon_blueImg = loadImage("blue.png");
    balloon_redImg = loadImage("red.png");
    balloon_yellowImg = loadImage("yellow.png");
...
function draw() {
    ...
    textSize(20);
    fill("black")
    text("Pop the balloons that match the color of Bheam's pendent", 10, 380);
